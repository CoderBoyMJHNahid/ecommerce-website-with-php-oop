<?php
    ...
    $search = $db->escapeString($_GET['search_query']);
?>
  <div class="col-lg-9">
          <div class="row py-5">
            ...
            <?php 
              $db->select("product","*","category ON product.cat = category.c_id","name LIKE '{$search}%'","p_id ASC","20");
              $result = $db->getResult();
                ...
                <div class="product-desc">
                  <form id="product_modal_form">
                    <div class="row">
                      ...
                      <div class="col-lg-12">
                        <button type="submit" class="btn btn-outline-primary w-50 mt-4">Add To Cart</button>
                      </div>
                    </div>
                  </form>
                </div>
